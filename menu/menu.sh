...
echo -e "                 ${BICyan}Base Script : ${BIPurple}Vpn Network Cloud Tunnel${NC}"
echo -e "                 ${BICyan}Bot Dev     : ${BIPurple}@Network Cloud Tunnel${NC}"
echo -e "                 ${BICyan}Decodec     :${BIPurple} @Network Cloud${NC}"
...
6969) clear ; wget https://raw.githubusercontent.com/TeknisiIT1/KIKO5/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
