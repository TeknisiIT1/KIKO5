...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To VPN NETWORK CLOUD TUNNEL ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}Vpn Network Cloud® ${NC}${YELLOW}(${NC} ${green} Vpn Network Cloud Tunnel${NC}${YELLOW})${NC}"
